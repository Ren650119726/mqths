 ...
 *
 */
package com.reefe.mqths.demo.springcloud.order.client;
...
import com.reefe.mqths.demo.springcloud.order.configuration.MyConfiguration;
...
public interface InventoryClient {
     ...
     * @return true 成功
     */
    @Mqth(destination = "inventory", target = InventoryService.class)
