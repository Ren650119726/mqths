...
package com.reefe.mqths.demo.springcloud.inventory.service.impl;
...
import com.reefe.mqths.demo.springcloud.inventory.api.service.InventoryService;
import com.reefe.mqths.demo.springcloud.inventory.mapper.InventoryMapper;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    public Boolean decrease(InventoryDTO inventoryDTO) {
        ...
        if (entity.getTotalInventory() < inventoryDTO.getCount()) {
            throw new MqthRuntimeException(" spring cloud inventory-service 库存不足!");
        }
